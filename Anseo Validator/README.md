...
| Icon Gradient    | ![#1A6DFF](https://via.placeholder.com/10/1A6DFF?text=+) #1A6DFF </br>![#C822FF](https://via.placeholder.com/10/C822FF?text=+) #C822FF |
...
| Color           | Hex                                                                                                                               |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| Logo Background | ![#000000](https://via.placeholder.com/10/000000?text=+) #000000                                                                  |
