...
| :----------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------: |
| <img src="Screenshots/Introduction-Authentication/Splash Screen.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Introduction-Authentication/Walkthrough_1st_page.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Introduction-Authentication/Walkthrough_2nd_page.jpg" alt="Anseo Transit Logo" /> |

|                                               Walkthrough                                               |                                               Walkthrough                                               |                                          Landing Page                                           |
| :-----------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------: |
| <img src="Screenshots/Introduction-Authentication/Walkthrough_3rd_page.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Introduction-Authentication/Walkthrough_4th_page.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Introduction-Authentication/Landing Page.jpg" alt="Anseo Transit Logo" /> |

|                                          Sign In                                           |                                           Sign Up                                            |                                           Sign Up                                            |
| :----------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------: |
| <img src="Screenshots/Introduction-Authentication/Sign In.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Introduction-Authentication/Sign Up 1.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Introduction-Authentication/Sign Up 2.jpg" alt="Anseo Transit Logo" /> |
...
|                                 Sign In                                 |                                 Sign Up                                 |                                 Sign Up                                 |
| :---------------------------------------------------------------------: | :---------------------------------------------------------------------: | :---------------------------------------------------------------------: |
| <img src="Screenshots/Home/Home Page 1.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Home/Home Page 2.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Home/Home Page 3.jpg" alt="Anseo Transit Logo" /> |
...
| :---------------------------------------------------------------------------: | :--------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------: |
| <img src="Screenshots/Ticket/Ticket Overview.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Ticket/Travel Card Overview.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Ticket/Add Travel Card or Ticket Options.jpg" alt="Anseo Transit Logo" /> |

|                                Add Travel Card                                |                                 Add Ticket                                 |                                 Add Ticket                                 |
| :---------------------------------------------------------------------------: | :------------------------------------------------------------------------: | :------------------------------------------------------------------------: |
| <img src="Screenshots/Ticket/Add Travel Card.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Ticket/Add Ticket 1.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Ticket/Add Ticket 2.jpg" alt="Anseo Transit Logo" /> |
...
| :----------------------------------------------------------------------------: | :----------------------------------------------------------------------------: | :----------------------------------------------------------------------------: | :----------------------------------------------------------------------------: |
| <img src="Screenshots/Plan Route/Plan Route 1.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Plan Route/Plan Route 2.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Plan Route/Plan Route 3.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Plan Route/Plan Route 4.jpg" alt="Anseo Transit Logo" /> |
...
| :-------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------: |
| <img src="Screenshots/Real Time/Real Time Info Options.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Real Time/Search by Stop Number 1.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Real Time/Search by Stop Number 2.jpg" alt="Anseo Transit Logo" /> |

|                                  Search by Stop Address                                   |                                  Search by Stop Address                                   |                                  Search by Map                                   |
| :---------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------: |
| <img src="Screenshots/Real Time/Search by Stop Address 1.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Real Time/Search by Stop Address 2.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Real Time/Search by Map 1.jpg" alt="Anseo Transit Logo" /> |

|                                  Search by Map                                   |                                 Real Time Results                                  |
| :------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------: |
| <img src="Screenshots/Real Time/Search by Map 1.jpg" alt="Anseo Transit Logo" /> | <img src="Screenshots/Real Time/Real Time Results.jpg" alt="Anseo Transit Logo" /> |
...
<div align="center"> 
  <img src="..\System Design/Three Tier Architecture/3 Tier Archietecture Diagram.png" alt="Three Tier Architecture" />
</div>
