/*
  ...
  Description: This file allows the user to select whether to sign in or sign up to the 
               application when either logged out or running the application for the first time
*/

// Imports utilised in this file
import 'package:flutter/material.dart';
import 'package:anseo_admin/pages/account/sign_in.dart';
import 'package:anseo_admin/pages/account/sign_up.dart';
      ...
      body: SafeArea(
        child: Column(
          children: <Widget>[
            // Application Logo
            Expanded(
              child: Image.asset("assets/logo/logo1_invert.png"),
            ),
