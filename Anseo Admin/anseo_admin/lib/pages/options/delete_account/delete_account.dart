/*
  ...
  File Name: delete_account.dart
  Description: This file allows the admin to select the type of account that they want to delete.
               The admin can choose to delete one of the following accounts from a dropdown list: 
               ...
               where the admin can specify the account to delete from a list of accounts with a specific 
               account type
*/
...
class _DeleteAccountState extends State<DeleteAccount> {
  ...
  */
  ...
  /*
    ...
    commonality to display the list of accounts. In this instance the admin wants to delete 
    an account rather than modify, hense the variable is set to true 
  */
  bool toDeleteAccount = true;
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    if (accountType.isNotEmpty) {
                      /* Create function call to get list of users, drivers or admins based on user selection */
                      ...
                      */
                      if (accountType == "User") {
                        ...
                        accountList = List.from(accountListQuery.docs.map(
                            (doc) => UserAccount(
                                userID: doc.id,
