/*
  ...
  File Description: This file allows the admin to sign in to the application by entering their details in the form. 
                    The data will be validated and processed by firebase_auth in signing in and checking if the 
                    account has been assigned admin privilages in order to use this application 
*/
              ...
              children: <Widget>[
                ...
                Center(
                  child: ElevatedButton(
                    ...
                    /* 
                      If the form validator doesnt produce any errors, the application will attempt to sign the admin in. 
                      If it encounters an error, it will be displayed to the admin.
                    */
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        if (result is FirebaseAuthException) {
                          ...
                          // The value that we want to obtain when we check the admin privilages of the account trying to sign in to the application
                          final isAdmin =
                              (await _auth.currentUserClaims)!['admin'] == true;

                          /* 
                            If the account has admin privilages, the admin will be redirected to the home screen in 'home.dart'. Otherwise, the admin will be 
                          ...
                          */
                          if (isAdmin) {
                            ...
                            setState(() {
                              error =
                                  "This account doesn't have privilages to access the admin application!";
                            });
                          }
