/*
  ...
  File Description: This file allows the user to sign in to the application by entering their details in the form. 
                    The data will be validated and processed by firebase_auth in signing in and checking if the 
                    account has been assigned user privilages in order to use this application 
*/
              ...
              children: <Widget>[
                ...
                Center(
                  child: ElevatedButton(
                    ...
                    /* 
                      If the form validator doesnt produce any errors, the application will attempt to sign the user in. 
                      If it encounters an error, it will be displayed to the user.
                    */
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        if (result is FirebaseAuthException) {
                          ...
                          // The value that we want to obtain when we check the user privilages of the account trying to sign in to the application
                          final isAdmin =
                              (await _auth.currentUserClaims)!['user'] == true;

                          /* 
                            If the account has user privilages, the user will be redirected to the homepage in 'homepage.dart'. Otherwise, the user will be 
